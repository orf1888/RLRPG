 ...
 * wywo³anie get(key, default) zwraca wartoœæ z mapy (jeœli istnieje) lub
 * wartoœc default w pozosta³ym przypadku
 */
...
public class MapWithDefaults {
	...
	public Object get(String key, Object deflt) {
		...
		// else
		if (map != null)
			L.log("MapWithDefaults: klucz \'" + key
					+ "\' pusty, uzywam default value: " + deflt);
		return deflt;
	}
