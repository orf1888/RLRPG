...
public class MainActivity extends Activity {
	static class EkranGlowny {
		...
		/**
		 * ustawia ewentualne listenery. Uwaga, jesli cos jest wywolane poza
		 * w¹tkiem UI, musi byc uzyte activity.runOnUiThread( new Runnable()
		 * Uwaga, jesli jakis listener odwo³uje siê poza UI (np. do modelu),
		 * trzeba go wywaliæ w funkcji dropListeners
		 */
		public void setListeners() {
			...
			challenge.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View v) {
					/* Dzia³a? */
					Utils.startNewActivity(context,
							ChallengeListViewActivity.class);
				}
			});
			community.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View v) {
					...
					// Toast.makeText( context, "Klikn¹³eœ community!",
	...
	public void onBackPressed() {
		...
		DialogBuilder exitDialog = new DialogBuilder(MainActivity.this,
				"Exit app", "Do you realy want to exit?", exitListener,
				DialogBuilder.createDefaultReturnListener(), "Yes", "No");
